...
func (app *application) routes() http.Handler {
	...
	mux.Get("/user/upload", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.uploadForm))
	mux.Post("/user/upload", dynamicMiddleware.Append(app.requireAuthentication).ThenFunc(app.upload))
	mux.Post("/delete", http.HandlerFunc(app.delete))
